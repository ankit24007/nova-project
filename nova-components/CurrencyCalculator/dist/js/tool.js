...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        convert: function convert() {
            ...
            fetch('https://api.exchangeratesapi.io/latest?base=INR').then(function (response) {
                return response.json();
            }).then(function (data) {
                var rate = data.rates[_this.currency];
                _this.result = rate * _this.inputData;
            });
        }
    }
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Currency Calculator")]),
      _vm._v(" "),
        ...
        _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
          _c(
            ...
            [
              _c(
                "option",
                { attrs: { value: "USD" }, domProps: { selected: true } },
                [_vm._v("USD")]
              ),
              _vm._v(" "),
      ...
      _c(
        ...
        {
          staticClass:
            "btn btn-default btn-primary inline-flex items-center relative mr-3",
          attrs: { type: "button", dusk: "create-and-add-another-button" },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "w-1/5 px-8 py-6" }, [
      _c("label", { staticClass: "inline-block text-80 pt-2 leading-tight" }, [
        _vm._v("\n                        Amount "),
